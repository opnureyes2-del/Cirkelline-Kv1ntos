    ...
    <>
      ...
      >
        ...
        <SelectContent className="border-none bg-light-surface font-dmmono shadow-lg dark:bg-dark-surface">
          <SelectItem value="agent" className="cursor-pointer text-light-text hover:bg-light-bg dark:text-dark-text dark:hover:bg-dark-bg">
            <div className="text-xs font-medium uppercase">Agent</div>
          </SelectItem>

          <SelectItem value="team" className="cursor-pointer text-light-text hover:bg-light-bg dark:text-dark-text dark:hover:bg-dark-bg">
